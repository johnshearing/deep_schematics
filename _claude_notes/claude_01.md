...
There is no reason to read that yet. I just want you to know the document is there if you need it and what it represents.  
...
There is no reason to look at that yet. I just want you to know the code is there if you need to reference it and what it represents.  

The following, at the top are instructions for the next job and below that is a record of our improvements as we work through the road map.  
