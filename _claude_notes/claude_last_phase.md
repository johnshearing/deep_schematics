...
You have already executed sessions 1, 2, and 3 which included plans 0, A, B, and C.  
I have worked through the lessons/tests in /home/js/schematics/_claude_notes/locate_tab_testing  
Everything functioned as expected.  

This is session 4.  
Please accomplish the tasks layed out in Phase F.  

Then I will test all these before we proceed to Session 5, Phases D + G  
