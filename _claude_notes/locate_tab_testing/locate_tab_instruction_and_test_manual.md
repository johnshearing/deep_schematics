...
against the files, not remembered:
    ...
    label_corrections.json  **Added 2026-09-02.** Schema 1, the third authored file,
                      ...
                      the queue has been worked end to end: 279 *not a label*, 272
                      confirmations, 103 corrected strings. The number that matters,
                      because it is what Phase E's matcher compares against: **24 of
                      the 26 nets now have at least one printed conductor carrying
                      their name, against 17 before the run.** The two that do not are
                      NET-PB1 and NET-PB2, and that is **K10** — the sheet prints PB1
                      and PB2 and the netlist prefixed them — rather than a reading
                      anybody can fix on that screen.
